...
<div class="counter-wrapper">
    ...
    <button class="btn btn-primary mt-2" id="increment">Incrementar</button>
</div>
    ...
    $(document).ready(function() {
        ...
        websocket.onopen = function(ev) {
            $('#increment').click(function() {
                var valorActual = parseInt($('#count').val(), 10);
                valorActual++;
                $('#count').val(valorActual);
                websocket.send(JSON.stringify({type: 'user', message: valorActual}));
            });
        };
